...
- [x] Project scaffolded in `/Users/eriksjaastad/projects/ollama-mcp`
...
3. Add a new MCP server with:
   - Name: `ollama`
   - Command: `node`
   - Args: `/Users/eriksjaastad/projects/ollama-mcp/dist/server.js`
...
**Solution:**
1. Check if server starts: `node /Users/eriksjaastad/projects/ollama-mcp/dist/server.js`
...
**Solution:**
```bash
chmod +x /Users/eriksjaastad/projects/ollama-mcp/dist/server.js
```
